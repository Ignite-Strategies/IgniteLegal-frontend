  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <PageHeader
        ...
        subtitle="12-month strategic roadmap for business development growth"
        ...
        <div className="text-center mb-8">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p className="text-gray-800 font-medium">
              This roadmap outlines the planned approach to help BusinessPoint Law increase customers through systematic business development activities.
            </p>
          </div>
        </div>
